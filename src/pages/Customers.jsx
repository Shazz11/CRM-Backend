...
//     // Fetch data
//     useEffect(()=>{
//       getCustomers() // Fetch cutomers data
//         .then(response => setCustomers(response.data))
//         .catch(error => console.log(`Error fetcing customers data: ${error}`))
...
//       console.log("Selected rows for deletion:", selectedRows); // Debugging
